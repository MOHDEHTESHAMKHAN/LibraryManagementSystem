...
<head>
    ...
    <title>Reset Password | MEK Library</title>
</head>
<body style="background-color: rgba(198, 236, 59, 0.837);">
    ...
    <script src="https://kit.fontawesome.com/1fd84f7b4a.js" crossorigin="anonymous"></script>
</body>
</html>